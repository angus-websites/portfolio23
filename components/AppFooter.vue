    ...
    >
      ...
      <div>
        <div class="grid grid-flow-col gap-4">
          <a v-if="footerData" class="text-lunar-800/90 hover:text-evening-sea-800 dark:text-lunar-200 dark:hover:text-evening-sea-100" :href="footerData.github" target="_blank">
          ...
          <a v-if="footerData" class="text-lunar-800/90 hover:text-evening-sea-800 dark:text-lunar-200 dark:hover:text-evening-sea-100" :href="footerData.linkedin" target="_blank">
...
const { data: footerData} = await fetchItem<FooterData>(`/globals/footer`);
